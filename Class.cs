...
namespace ConsoleApp1
{
    ...
    class Programm
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Вивести одержаний рядок, 
            //а також статистику по обробці:
            ...
            //----------------#3-------------
            //
            //Створити метод, що приймає введений користувачем рядок і виводить на екран статистику по цьому рядку. 
